...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("cadastral_number", sa.String(64)),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "plot_id", sa.Integer(), sa.ForeignKey("land_plots.id"), nullable=False, unique=True
        ),
    ...
    op.create_table(
        "sent_reminders",
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("plot_id", sa.Integer(), sa.ForeignKey("land_plots.id"), nullable=False),
        sa.Column("kind", sa.String(64), nullable=False),
        sa.Column("due_date", sa.Date(), nullable=False),
        sa.Column("sent_at", sa.DateTime(), nullable=False),
        sa.UniqueConstraint("plot_id", "kind", "due_date", name="uq_reminder"),
    )
